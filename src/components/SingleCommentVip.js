...
const SingleCommentVip = ({objKey,objValue, userObj}) => {
    ...
    return(
        <div>
                        ...
                        <div className= "singleComment">    
                            <div class= "notranslate" className="commentMsg" >
                            
                            {objKey.toString().replace(/[0-9]/g,"") === userObj.displayName+"." ? (
                                <>
                                <span class= "notranslate" className="commentOwner__name">
...
export default SingleCommentVip;